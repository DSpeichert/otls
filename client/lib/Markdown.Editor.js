...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttons.code = makeButton("wmd-code-button", "Code Sample - Ctrl+K", "glyphicon glyphicon-file", bindCommand("doCode"), group2);
            ...
            group3 = makeGroup(3);
            buttons.olist = makeButton("wmd-olist-button", "Numbered List - Ctrl+O", "glyphicon glyphicon-list-alt", bindCommand(function (chunk, postProcessing) {
